...
float theta = 0.0, scale = 0.5, dx = 7, dy = -3, dz = 0.5;
//rotation, scale , and translation for polwoman
float thetaw = 0.0, scalew = 0.5, dxw = -7, dyw = -3, wdz = 0.0;
//rotation, scale, and translation for square
float thetas = 0.0, scales = 0.5, dxs = -7, dys = -3, sdz = 0.0;
void SetupRC(void);
...
void RenderScene(void) {
	...
	glOrtho(-7.0, 7.0, -7.0, 7.0, -2.0, 2.0);
	//call loadicon
